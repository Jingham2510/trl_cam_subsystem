...
//const FRONT_SPOKE_TRANSFORM : Matrix4<f32> = matrix![-0.13040724, -0.96353104, -0.23367047,  1.0161756; 
  //                                                   0.96770448, -0.17498028,  0.18146607, -0.45681312;
    //                                                -0.21573591, -0.20245947,  0.955232,   -0.97211699;
      //                                              0.0,          0.0,          0.0,          1.        ];

const FRONT_SPOKE_TRANSFORM : Matrix4<f32> = matrix![-0.13040724,  0.96770448, -0.21573591,  0.36485622;
                                                    -0.96353104, -0.17498028, -0.20245947,  0.70236915;
                                                    -0.23367047,  0.18146607,  0.955232,    1.24894357;
                                                    0.0,          0.0,          0.0,          1.0 ];
