...
const FRONT_SPOKE_TRANSFORM : Matrix4<f32> = matrix![-0.13123876, -0.96158025, -0.24112199,  1.02589258; 
                                                     0.96331326, -0.17498028,  0.18146607, -0.45681312;
...
impl SystemController{
    ...
    fn workspace_transform(&self, pcl_list : &mut Vec<PointCloud>){
        ...
        for (i ,pcl) in pcl_list.iter_mut().enumerate(){  
            ...
            let delta_pos : [f32;3] = [(og_pos[0] - self.curr_pos[0]) /1000.0, (og_pos[1] - self.curr_pos[1]) /1000, (og_pos[2] - self.curr_pos[2]) / 1000];
