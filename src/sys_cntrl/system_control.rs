...
const FRONT_SPOKE_TRANSFORM : Matrix4<f32> = matrix![0.9617973, -0.12711734, -0.24246046, -0.67917454;
                                                    -0.09594642,  -0.9860048,  0.13634092,  0.90173036;
                                                    -0.25639847, -0.10786913, -0.96053326,   2.4770067;
                                                    0.0,          0.0,          0.0,          1.        ];
...
impl SystemController{
    ...
    pub fn calc_calib_mats(&mut self, delete_calib_imgs : bool) -> Result<(), anyhow::Error>{
        ...
        const MARKER_COORDS : [[f32; 3]; 4] = [[0.0, 0.0, BOARD_THICKNESS], [0.0, BOARD_SIZE, BOARD_THICKNESS], [BOARD_SIZE, 0.0, BOARD_THICKNESS], [BOARD_SIZE, BOARD_SIZE, BOARD_THICKNESS]];
